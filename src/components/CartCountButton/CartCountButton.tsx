...
function CartCountButton({ quantity }: Props) {
    ...
    const handleCountValue = (event: ChangeEvent<HTMLInputElement>): void => {
    ...
    return (
        ...
        >
            <button className={styles.cartCountButton__button} aria-label="add">
                <svg
                    aria-hidden="true"
                    width="22"
                    height="3"
